...
def test_mu_n2_err():
    with raises(ValueError):
        _ = cm.mu_yaws('N2', 6010)


def test_mu_nh3_err():
    with raises(ValueError):
        _ = cm.mu_yaws('NH3', 900)


def test_mu_c2cl2f4_err():
    with raises(ValueError):
        _ = cm.mu_yaws('C2Cl2F4', 900)
